...
using eMeetup.Modules.Attendance.Infrastructure.Inbox;
using eMeetup.Modules.Attendance.Infrastructure.Outbox;
using eMeetup.Modules.Users.IntegrationEvents;
using eMeetup.Modules.Attendance.Infrastructure.Authentication;
using MassTransit;
...
namespace eMeetup.Modules.Attendance.Infrastructure;
